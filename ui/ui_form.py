...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1008, 723)
        MainWindow.setMinimumSize(QSize(1008, 723))
        MainWindow.setMaximumSize(QSize(1008, 723))
        font = QFont()
        ...
        self.title.setGeometry(QRect(30, 20, 271, 91))
        font1 = QFont()
        ...
        self.record_midi_Frame.setGeometry(QRect(360, 160, 631, 551))
        ...
        self.midiframe.setGeometry(QRect(10, 290, 601, 170))
...
"background-color: #45259b;")
        ...
        self.mid_frame_label.setGeometry(QRect(10, 260, 111, 21))
        font3 = QFont()
        ...
        self.playmidiButton = QPushButton(self.record_midi_Frame)
        self.playmidiButton.setObjectName(u"playmidiButton")
        self.playmidiButton.setEnabled(True)
        self.playmidiButton.setGeometry(QRect(220, 450, 181, 60))
        self.playmidiButton.setMinimumSize(QSize(60, 60))
        font4 = QFont()
        font4.setFamilies([u"Ubuntu"])
        font4.setPointSize(18)
        font4.setBold(True)
        self.playmidiButton.setFont(font4)
        self.playmidiButton.setStyleSheet(u"border-radius: 30px;\n"
"background-color: #45259b;")
        self.playmidiButton.setIcon(icon2)
        self.playmidiButton.setIconSize(QSize(35, 35))
        self.playmidiButton.setCheckable(True)
        self.playmidiButton.setChecked(False)
...
"border-radius: 10px")
        ...
        self.save_voice_label.setFont(font5)
...
"background-color: #45259b")
        ...
        self.save_voice_field.setFont(font5)
...
"}")
        ...
        self.hundred_perc.setFont(font6)
...
"border-radius: 10px")
        ...
        self.save_midi_field.setFont(font5)
...
"")
        ...
        self.save_midi_label.setFont(font5)
...
"")
        ...
        font8.setBold(False)
        self.record_parameters_header_11.setFont(font8)
...
#if QT_CONFIG(tooltip)
        self.playmidiButton.setToolTip(QCoreApplication.translate("MainWindow", u"Play/ Pause MIDI track", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.playmidiButton.setStatusTip(QCoreApplication.translate("MainWindow", u"Play/Pause MIDI track", None))
#endif // QT_CONFIG(statustip)
        self.playmidiButton.setText(QCoreApplication.translate("MainWindow", u"PLAY MIDI", None))
